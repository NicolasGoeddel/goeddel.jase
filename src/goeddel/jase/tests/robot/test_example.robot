...
#
#  $ bin/test -s goeddel.jase -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src goeddel.jase.testing.GOEDDEL_JASE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/goeddel/jase/tests/robot/test_example.robot
#
